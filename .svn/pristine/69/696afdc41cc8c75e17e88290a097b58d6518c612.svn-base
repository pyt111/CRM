	...
	<div class="zhan_mian">
		<div ref="mian">
			<Row>
				<Col :span="5">
				<span>用户姓名：</span>
				<Input placeholder="请输入..." style="width: 140px" size="small" v-model="trueName" @on-enter="check"></Input>
				</Col>
                <Col :span="5">
				<span>用户手机号：</span>
				<Input placeholder="请输入..." style="width: 140px" size="small" v-model="phone" @on-enter="check"></Input>
