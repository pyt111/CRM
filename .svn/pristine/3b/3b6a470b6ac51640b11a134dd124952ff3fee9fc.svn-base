<template>
    <div>
        ...
        <div class="suc">
            ...
            <div class="succss2">
                <div class="succss2_div">
                    <p class="succss2_div1">￥{{result.thisSaleAchieve}}
                        <span style="font-size:12px;color:#ccc"> 元</span>
                    </p>
        ...
        <div class="suc">
            ...
            <div class="succss2">
                <div class="succss2_div">
                    <p class="succss2_div1">{{result.thisMonthCount}}
                        <span style="font-size:12px;color:#ccc"> 人</span>
                    </p>
        ...
        <div class="suc">
            ...
            <div class="succss2">
                <div class="succss2_div">
                    <p class="succss2_div1">{{result.achieveIsNotClose}}
                        <span style="font-size:12px;color:#ccc"> 元</span>
                    </p>
